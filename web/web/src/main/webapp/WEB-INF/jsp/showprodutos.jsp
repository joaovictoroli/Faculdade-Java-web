...
<body class= "bg-dark">
    <body class="d-flex flex-column h-100">
       <main class="flex-shrink-0">
            ...
            <div class="container px-8">
               ...
               <table class="table table-striped table-sm">
                   ...
                   <c:forEach var="produto" items="${produtos}">
                       <tr>
                           <td>
                               <p class="text-white">${produto.pid}</p></td>
                           <td><p class="text-white">${produto.nome}</p></td>
                           <td><p class="text-white">${produto.descricao}</p></td>
                           <td><p class="text-white">${produto.preco}</p></td>
                           <td>
                               <a href="/update-produto/${produto.pid}"><span class="material-icons text-white">edit_note
                                   </span></a></td>
                           <td>
                                <a href="/delete-produto/${produto.pid}">                     
           ...
           <br/> 
           <a href="/create-produto">               
           <button type="button" class="btn btn-secondary">Add Produto</button>
           </a>
            </div>
        </header>
         </main>
