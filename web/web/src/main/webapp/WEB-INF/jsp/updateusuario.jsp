       ...
       <main class="flex-shrink-0">
           ...
           <header class="bg-dark py-5">
            <div class="container px-8">
                <h1 class="text-white">Update Usuario</h1>
            </br>
            <c:out value="${email}" />
            <form:form method="post" action="/update-usuario/${email}">
                    ...
                    <div class="form-group">
                       <p class="text-white">UF: 
                            <c:out value="${endereco.uf}" />
                        </p>
                    </div>
                    <div class="form-group">
                        <p class="text-white">Localidade: 
                             <c:out value="${endereco.localidade}" />
                         </p>
                     </div>
                     <div class="form-group">
                        <p class="text-white">Bairro: 
                             <c:out value="${endereco.bairro}" />
                         </p>
                     </div>
                     <div class="form-group">
                        <p class="text-white">Logradoro: 
                             <c:out value="${endereco.logradoro}" />
                         </p>
                     </div>
